...
def build_parser() -> argparse.ArgumentParser:
    ...
    clip_write_mode.add_argument(
        ...
        action="store_true",
        help=(
            "Explicitly enable Phase 6 bounded MIDI pitch, attack-velocity, or "
            "exact note-deletion correction previews and immutable Clip version "
            "creation; requires --clip-library, --phase6-acceptance and "
            "--phase6-pack"
        ),
    )
