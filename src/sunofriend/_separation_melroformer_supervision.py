...
def _build_native_real_worker_supervision_plan() -> Mapping[str, Any]:
    ...
    payload = {
        ...
        "missing_bridge": {
            "fixed_real_worker_native_entrypoint_implemented": True,
            ...
            "descriptor_native_checkpoint_inspection_implemented": True,
            "descriptor_native_checkpoint_tensor_load_implemented": True,
        ...
        "limitations": [
            ...
            "fixed_real_worker_entrypoint_has_not_been_launched_by_native_owner",
            ...
            "descriptor_native_checkpoint_loader_attached_but_not_live_exercised",
