...
- [ ] Independently reproduce conversion parity, prove operating-system network
  denial, then add verified PCM24 persistence behind the private worker
