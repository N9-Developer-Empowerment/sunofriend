...
| [Banquet / Query Bandit](https://github.com/kwatcharasupat/query-bandit) | Query-conditioned music separation with published training classes for acoustic/clean/distorted guitar, electric piano, organ, synth pad and synth lead. It requires one ten-second audio query rather than a fixed decoder role. | Source revision `79ed5bb75e5c3a40cd319d9d990cee913fc65c26` has an exact isolated CPython 3.12.10/macOS-arm64 runtime, completed network-denied construction/load evidence and one successful generated-tensor synthetic forward. A later separately approved rights-bound canary completed exactly nine song-disjoint CPU attempts in 64.01 seconds at 3.26 GB peak RSS. All 36 private PCM24 artifacts matched their hashes and reconstructed within zero LSB, with zero network or forbidden-audio attempts. The proposed profile remains unregistered and non-executable. | MIT source. The Banquet checkpoint SHA-256 is `657295888781e62ef50593002720d2edb3858b9e5bbfabf0c54f715a0da4b9e2` under CC BY-NC-SA 4.0. The required OpenMIC PaSST SHA-256 is `dc229428753176e8be0373d25887116fc15b490af86f671cecf9ed76a0f287da`. The restricted gate matched all 1,228 combined state keys, shapes and dtypes and strictly loaded both with zero network or audio access. | First bounded candidate for guitar plus broad `keyboard_synth`. Local noncommercial research only; no hosting, checkpoint redistribution, commercial default, automatic source choice or MIDI activation. The synthetic target was extremely quiet and reference target peaks varied widely, so musical usefulness remains unestablished pending human listening. Both approved inference authorities are consumed; poor feedback cannot trigger a query hunt, and further inference needs a new reviewed plan and explicit approval. |
