...
- [ ] Compare Kim Vocal 2 against the sealed HTDemucs and provider vocal
  controls, independently reproduce conversion parity, prove operating-system
  network denial, then add verified PCM24 persistence behind the private worker
  protocol before considering vocal MIDI or listening-quality promotion.
