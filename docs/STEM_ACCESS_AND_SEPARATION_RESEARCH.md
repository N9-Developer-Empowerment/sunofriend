...
| [Banquet / Query Bandit](https://github.com/kwatcharasupat/query-bandit) | Query-conditioned music separation with published training classes for acoustic/clean/distorted guitar, electric piano, organ, synth pad and synth lead. It requires one ten-second audio query rather than a fixed decoder role. | Source revision `79ed5bb75e5c3a40cd319d9d990cee913fc65c26` exposes a CPU flag, but Apple-silicon compatibility and resources are unverified. The proposed profile is blocked, unregistered and non-executable. | MIT source. The approved evidence-only download of Zenodo record `13694558` matched its published 645,470,187-byte size and MD5 and established SHA-256 `657295888781e62ef50593002720d2edb3858b9e5bbfabf0c54f715a0da4b9e2`. Network-denied opcode inspection found only standard state-dict globals but did not deserialize the CC BY-NC-SA 4.0 checkpoint or establish loading safety. | First bounded candidate for guitar plus broad `keyboard_synth`. Local noncommercial research only; no hosting, checkpoint redistribution, commercial default, provider-stem query, automatic source choice or MIDI activation. Dependencies, loading and inference remain unapproved. |
