...
| [Banquet / Query Bandit](https://github.com/kwatcharasupat/query-bandit) | Query-conditioned music separation with published training classes for acoustic/clean/distorted guitar, electric piano, organ, synth pad and synth lead. It requires one ten-second audio query rather than a fixed decoder role. | Source revision `79ed5bb75e5c3a40cd319d9d990cee913fc65c26` now has an exact isolated CPython 3.12.10/macOS-arm64 runtime and a completed network-denied construction/load gate; inference compatibility and resources remain unverified. The proposed profile is blocked, unregistered and non-executable. | MIT source. The Banquet checkpoint SHA-256 is `657295888781e62ef50593002720d2edb3858b9e5bbfabf0c54f715a0da4b9e2` under CC BY-NC-SA 4.0. The required OpenMIC PaSST SHA-256 is `dc229428753176e8be0373d25887116fc15b490af86f671cecf9ed76a0f287da`. The restricted gate matched all 1,228 combined state keys, shapes and dtypes and strictly loaded both with zero network or audio access. | First bounded candidate for guitar plus broad `keyboard_synth`. Local noncommercial research only; no hosting, checkpoint redistribution, commercial default, provider-stem query, automatic source choice or MIDI activation. Model construction/loading is complete; inference and audio processing remain unapproved. |
