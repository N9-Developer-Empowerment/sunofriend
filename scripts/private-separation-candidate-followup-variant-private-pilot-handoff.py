...
def main() -> int:
    ...
    parser.add_argument("--final-readiness-result", required=True)
    ...
    result = _prepare_private_candidate_followup_variant_pilot_handoff(
        args.final_readiness_result,
        final_acceptance_result_path=args.final_acceptance_result,
