#!/usr/bin/env python3
"""Build independent final-acceptance pages for every eligible variant."""
...
def main() -> int:
    ...
    result = _build_private_candidate_followup_variant_final_acceptance_reviews(
        args.readiness_result,
