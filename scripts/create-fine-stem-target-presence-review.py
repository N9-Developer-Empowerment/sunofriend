#!/usr/bin/env python3
"""Prepare the source-only synth/guitar presence review."""
...
from sunofriend.separation_target_presence_plan import (  # noqa: E402
...
def main() -> int:
    ...
    if args.plan:
        ...
        print(json.dumps(build_target_presence_plan(), indent=2, sort_keys=True))
        return 0
    ...
    manifest = prepare_presence_review(stem_root=args.stem_root, out=args.out)
