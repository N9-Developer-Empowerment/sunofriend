#!/usr/bin/env python3
"""Run the model-free private macOS native-image inventory canary."""
...
from sunofriend._separation_macos_loaded_images import (
    _run_private_macos_native_image_inventory_canary,
)
...
def main() -> int:
    ...
    evidence = _run_private_macos_native_image_inventory_canary(
